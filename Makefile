...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/hetznercloud/terraform-provider-hcloud/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-hcloud_v$(TERRAFORM_PROVIDER_VERSION)
